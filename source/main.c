...
// The code should still be considered copyright of `crediar` though. Except for the LOWORD, __ROL__, and bswap16 stuff.
...
LABEL_69:
    ...
    if (v52)
    {
        size_t bytes_written = fwrite(outbuf1, 1u, Countb, v52);
        printf("Wrote:%d\n", bytes_written);
        fclose(v53);
        result = 1;
    }
